...
if __name__ == '__main__':
    ...
    if not opt.evolve:  # Train normally
        ...
        hyp = hyp_x
        train(0.225, 0.001, 0.937, 0.000484, opt.epochs)  # train normally
        ...
        # last_maps = train(best_weight, 150)
        ...
        # iou_hyp = [0.125, 0.375]
        # lr_hyp = [0.00333, 0.00666]
        # momentum_hyp = [0.933, 0.966]
        # weight_hyp = [0.000333, 0.000666]
        ...
        #     print(weight_baru)
        #     map_now = train(weight_baru, jumlah_epochs)

        #     if best_map < map_now:
        #         best_map = map_now
        #         best_weight = weight_baru
            
        #     hasil_sementara = [nmr, weight_baru,map_now]
        #     # acak_lama = acak_baru
        #     print("=========================")
        #     print("Iterasi ke : "+str(nmr))
        #     print("=========================")
